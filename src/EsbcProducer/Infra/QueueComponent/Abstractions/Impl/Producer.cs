...
namespace EsbcProducer.Infra.QueueComponent.Abstractions.Impl
{
    public class Producer : IProducer
    {
        ...
        public async Task<bool> Send(string topicName, object message, CancellationToken stoppingToken = default)
        {
